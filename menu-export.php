...
require 'includes/bs3_nav_walker.php';
require 'includes/bs4_nav_walker.php';
    ...
    public function main()
    {
        ...
        if ((isset($_REQUEST['bootstrap']) && $_REQUEST['bootstrap'] == 1)
          || (isset($_REQUEST['bootstrap3']) && $_REQUEST['bootstrap3'])) {
            $options['walker'] = new WP_Menu_Export_Bootstrap3_Navwalker();
        }

        if ((isset($_REQUEST['bootstrap4']) && $_REQUEST['bootstrap4'] == 1)) {
            $options['walker'] = new WP_Menu_Export_Bootstrap4_Navwalker();
        }
